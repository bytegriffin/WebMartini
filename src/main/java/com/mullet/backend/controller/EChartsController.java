...
import com.mullet.backend.chart.ecchart.structure.bar.CategoryBar;
import com.mullet.backend.chart.ecchart.structure.bar.MixLineBar;
import com.mullet.backend.chart.ecchart.structure.bar.NegativeBar;
import com.mullet.backend.chart.ecchart.structure.funnel.FunnelData;
import com.mullet.backend.chart.ecchart.structure.funnel.SimpleFunnel;
import com.mullet.backend.chart.ecchart.structure.gauge.SimpleGauge;
import com.mullet.backend.chart.ecchart.structure.line.DynamicAreaLine;
import com.mullet.backend.chart.ecchart.structure.line.StackLine;
import com.mullet.backend.chart.ecchart.structure.line.TrendLine;
import com.mullet.backend.chart.ecchart.structure.map.ChinaMap;
import com.mullet.backend.chart.ecchart.structure.map.MapData;
import com.mullet.backend.chart.ecchart.structure.pie.NestPie;
import com.mullet.backend.chart.ecchart.structure.pie.PieData;
import com.mullet.backend.chart.ecchart.structure.pie.RosePie;
import com.mullet.backend.chart.ecchart.structure.pie.SimplePie;
import com.mullet.backend.chart.ecchart.structure.radar.Indicator;
import com.mullet.backend.chart.ecchart.structure.radar.SimpleRadar;
import com.mullet.backend.chart.ecchart.structure.scatter.SimpleScatter;
