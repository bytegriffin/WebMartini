...
import com.mullet.backend.chart.chartjs.structure.ChartjsData;
import com.mullet.backend.chart.chartjs.structure.DataSet;
...
import com.mullet.backend.util.PrintUtil;
...
public class UserController {
	...
	public String uploadAvatar(@RequestParam(value = "file") MultipartFile file, HttpServletRequest request) {
		...
		String fileName = Constant.AVATAR_UPLOAD_PATH + user.getId() + "/" +file.getOriginalFilename();
		try {
			if (file.isEmpty()) {
