...
public class ShiroRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken)
		...
		passwordRetryCache = (EhCache) cacheManager.getCache(SiteConfig.SHIRO_PASSWORD_RETRY_CACHE);
	...
	public SimpleAuthenticationInfo getSimpleAuthenticationInfo(String username, String password) {
		return new SimpleAuthenticationInfo(username, password, ByteSource.Util.bytes(SiteConfig.SHIRO_CREDENTIALS_SALT), getName());
	}
	...
	public SimpleAuthorizationInfo getSimpleAuthorizationInfo(String username) {
		...
		permissions.add(SiteConfig.SHIRO_PERMISSION_COMMON);
	...
	public void clearAllCached() {
		...
		EhCache<Object, Object> sessionCache = (EhCache<Object, Object>) activeSessionCache
				.getCache(SiteConfig.SHIRO_ACTIVE_SESSION_CACHE_NAME);
