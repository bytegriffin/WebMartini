...
<div class="x_panel">
	<div class="x_conten" >
				<h4>请先下载<a href="${request.contextPath}/template/group.xlsx" class="green">模板</a>，再进行上传。</h4>
				<div id="kv-avatar-errors" class="center-block" style="display:none" role="alert"></div>
				<form class="text-center" action="${request.contextPath}/group/import/excel" method="post" enctype="multipart/form-data">
...
$("#input-repl-1a").fileinput({
	 language:"zh",
   uploadUrl: "${request.contextPath}/group/import/excel",
   uploadAsync:true,
   autoReplace: true,
