...
<form id="form_new" class="form-horizontal form-label-left" action="${request.contextPath}/group/add" method="post">
 <br />
      ...
      fields: {
         name: {
             ...
             validators: {
                 ...
                 remote: {url: '${request.contextPath}/group/validate?flag=name&t='+(new Date()).getTime() , message: '此组织名称已被使用' }
			                  }
			          }
             }
