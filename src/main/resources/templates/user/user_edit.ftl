...
<form id="form_edit" class="form-horizontal form-label-left" action="${request.contextPath}/user/edit" method="post">
...
<br />
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <input type="text" class="form-control" name="loginName" placeholder="由4-20个字符组成"   maxlength="20" value="${user.loginName}"/> 
            ...
            <div class="form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <select id="role" name="role" class="form-control" multiple="multiple" data-placeholder="选择一个或多个角色">
						<#list roles as cur>
								<option value="${cur.id}" <#if cur.selected?? &&cur.selected> selected="selected" </#if> > ${cur.name} </option>
						</#list>
					</select>	
                 </div>
            </div>
            ...
            <div class="form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <input type="text" class="form-control" name="email" placeholder="国内常用邮箱"  maxlength="20" value="${user.email}"/>
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" class="form-control" name="phone" maxlength="20" value="${user.phone}"/>
      ...
      fields: {
         loginName: {
             ...
             validators: {
                 ...
                 remote: {url: '${request.contextPath}/user/validate?id=${user.id}&flag=loginName&t='+(new Date()).getTime() ,message: '此登陆名已被其他人使用' }
			                  }
			          },
			    password: {
         ...
         email: {
            ...
            validators: {
                 ...
                 remote: {url: '${request.contextPath}/user/validate?id=${user.id}&flag=email&t='+(new Date()).getTime() ,message: '此邮箱已被其他人使用' }
                                    }
                         },
        phone: {
