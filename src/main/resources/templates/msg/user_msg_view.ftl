                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <#if message.attachment1??><tr><th nowrap>消息附件1  </th><td> <a href="javascript:download1()"  class="btn-link">下载</a> </td></tr></#if>
                        <#if message.attachment2??><tr><th nowrap>消息附件2  </th><td><a href="javascript:download2()" class="btn-link">下载</a> </td></tr></#if>
                        <#if message.attachment3??><tr><th nowrap>消息附件3  </th><td><a href="javascript:download3()" class="btn-link">下载</a>  </td></tr></#if>
                      </tbody>
                    </table>
