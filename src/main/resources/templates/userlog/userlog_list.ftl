...
<div class="page-title">
           ...
           <div class="clearfix"></div>
                ...
                <div class="x_panel">
									          ...
									          <li role="presentation" class="active"><a href="#tab_content1" id="log-tab" role="tab" data-toggle="tab" aria-expanded="true">用户日志</a></li>
									          <li role="presentation" class=""><a href="#tab_content2" role="tab" id="error-tab" data-toggle="tab" aria-expanded="false">系统异常</a></li>
									      </ul>
   ...
   　 order: [[1, "desc"]], //默认排序
     ...
     columns: [
	      	 { data: "id",visible:false },
       		 ...
       		 { data: "url" ,width:100,"orderable":false},
    	  		 { data: "operType","orderable":false,width:100},
    	  		 { data: "operContent","orderable":false,width:100}
         	        ],  
