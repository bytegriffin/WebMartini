...
<form id="form_edit" class="form-horizontal form-label-left" action="${request.contextPath}/role/edit" method="post">
      ...
      fields: {
         name: {
             ...
             validators: {
                 ...
                 remote: {url: '${request.contextPath}/role/validate?id=${role.id}&flag=name&t='+(new Date()).getTime() , message: '此角色名称已被使用' }
			                  }
			          }
             }
